...
public interface InputGate<T extends Record> extends Gate<T> {
   ...
   *
   * @param pos the position to retrieve the channel from
   ...
   * @throws InterruptedException thrown if the thread is interrupted while waiting for the gate to be closed
   */
