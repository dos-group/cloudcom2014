...
public class EnvironmentWrapper implements Environment {
	...
	public int getNumberOfOutputChannels() {
		return this.wrappedEnvironment.getNumberOfOutputChannels();
	}
	...
	public int getNumberOfInputChannels() {
		return this.wrappedEnvironment.getNumberOfInputChannels();
	}
	...
	public Set<ChannelID> getOutputChannelIDs() {
		return this.wrappedEnvironment.getOutputChannelIDs();
	}
	...
	public Set<ChannelID> getInputChannelIDs() {
		return this.wrappedEnvironment.getInputChannelIDs();
	}
	...
	public Set<GateID> getOutputGateIDs() {
		return this.wrappedEnvironment.getOutputGateIDs();
	}
	...
	public Set<GateID> getInputGateIDs() {
		return this.wrappedEnvironment.getInputGateIDs();
	}
	...
	public Set<ChannelID> getOutputChannelIDsOfGate(GateID gateID) {
		return this.wrappedEnvironment.getOutputChannelIDsOfGate(gateID);
	}
